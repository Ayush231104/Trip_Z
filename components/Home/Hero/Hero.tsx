      ...
      <div className="absolute z-[100] w-full h-full top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
        <div className="flex items-center justify-center flex-col w-full h-full ">
          <div data-aos="fade-up">
            <h1
              className="text-[25px] mb-4 md:mb-0 text-center md:text-[35px] md:text-[45px] tracking-[0.7rem] 
          ...
          >
            <span className="absolute right-0 w-8 h-32 -mt-12 py-2.5 transition-all duration-1000 transform 
