    ...
    <div className={` ${navBg ? "bg-blue-950 shadow-md": "fixed"} transition-all duration-200 h-[12vh] z-[1000] fixed w-full`}>
      <div className="flex items-center h-full justify-between w-[90%] xl-[80%] mx-auto">
        ...
        <div className="flex items-center space-x-2">
          ...
          <h1 className="text-xl md:text-2xl text-white uppercase font-bold">Trip-Z</h1>
        </div>
        {/* NavLink */}
        <div className="hidden lg:flex items-center space-x-10">
          {navLinks.map((link) => {
            return <Link href={link.url} key={link.id}>
              ...
              after:absolute after:h-[3px] after:bg-amber-400 after:w-full after:scale-x-0 hover:after:scale-x-100
        ...
        <div className="flex items-center space-x-4">
          ...
          trasition-all duration-200 rounded-lg">Book Now</button>
          {/* burgerMenu */}
